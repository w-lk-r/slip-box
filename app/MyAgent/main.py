...
from tools.notes import write_note, search_notes, trigger_kb_sync, fetch_url, write_summary, update_summary
...
tools = [write_note, write_summary, update_summary, search_notes, trigger_kb_sync, fetch_url]
